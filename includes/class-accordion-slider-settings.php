		...
		if ( empty( self::$plugin_settings ) ) {
			self::$plugin_settings = array(
				...
				'cache_expiry_interval' => array(
					...
					'default_value' => 24,
					'description' => __( 'Indicates the time interval after which an accordion\'s cache will expire. If the cache of an accordion has expired, the accordion will be rendered again and cached the next time it is viewed.', 'accordion-slider' )
				),
